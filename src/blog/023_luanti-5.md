...
!![Со стороны]({{media}}/newhouse1_1.jpg)  
!![Со стороны]({{media}}/newhouse1_2.jpg)  
!![Внутри]({{media}}/newhouse1_3.jpg)  
!![Внутри]({{media}}/newhouse1_4.jpg)  
!![Другие дома]({{media}}/otherhouses.jpg)

Мой новый дом:

!![Новый дом]({{media}}/current1.jpg)  
!![Новый дом]({{media}}/current2.jpg)  
!![Новый дом]({{media}}/current3.jpg)  
!![Новый дом]({{media}}/current4.jpg)  
!![Новый дом]({{media}}/current5.jpg)  
!![Новый дом]({{media}}/current6.jpg)  
!![Новый дом]({{media}}/current7.jpg)
...
!![Кто-то поселился в моей пещере]({{media}}/who.jpg)  
!![Кровать 1, не сломал]({{media}}/bed1.jpg)  
!![Кровать 2, сломал]({{media}}/bed2.jpg)  
!![Переписка табличками]({{media}}/signs.jpg)
